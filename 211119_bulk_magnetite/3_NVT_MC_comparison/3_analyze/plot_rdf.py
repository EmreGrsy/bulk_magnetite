...
fe2fe2_nvt = pd.read_csv("1_nvt/fe2_fe2_g_r_last10ns_delta0.001_step1.data", sep="\s+", header=None)
fe3fe3_nvt = pd.read_csv("1_nvt/fe3_fe3_g_r_last10ns_delta0.001_step1.data", sep="\s+", header=None)
fe2fe3_nvt = pd.read_csv("1_nvt/fe2_fe3_g_r_last10ns_delta0.0001_step1.data", sep="\s+", header=None)
...
fe3fe3_nvt["RDF"] = fe3fe3_nvt["RDF"] + 4.6

ax2.plot(fe2fe2_nvt["Distance"], fe2fe2_nvt["RDF"], "b", linewidth=2, label="$\mathrm{{Fe^{2+}}}$")
ax2.plot(fe3fe3_nvt["Distance"], fe3fe3_nvt["RDF"], "r", linewidth=2, label="$\mathrm{{Fe^{3+}}}$")
ax2.plot(fe2fe3_nvt["Distance"], fe2fe3_nvt["RDF"], "green", linewidth=2, label="$\mathrm{{Fe^{3+}Fe^{2+}}}$")
...
figure.savefig('RDF_NVT.pdf',format='pdf', bbox_inches = "tight")
figure.savefig('RDF_NVT.png',dpi=300.0,format='png', bbox_inches = "tight")