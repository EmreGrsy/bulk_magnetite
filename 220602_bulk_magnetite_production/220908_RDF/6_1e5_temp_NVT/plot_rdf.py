...
fe2fe2_nvt = pd.read_csv("fe2_fe2_delta_0.001_10e5.data", sep="\s+", header=None)
fe3fe3_nvt = pd.read_csv("fe3_fe3_delta_0.001_10e5.data", sep="\s+", header=None)
fe2fe3_nvt = pd.read_csv("fe3_fe2_delta_0.001_10e5.data", sep="\s+", header=None)
...
fe3fe3_nvt["RDF"] = fe3fe3_nvt["RDF"] + 6.6
...
figure.savefig('RDF_NVT_10e5.pdf',format='pdf', bbox_inches = "tight")
figure.savefig('RDF_NVT_10e5.png',dpi=300.0,format='png', bbox_inches = "tight")