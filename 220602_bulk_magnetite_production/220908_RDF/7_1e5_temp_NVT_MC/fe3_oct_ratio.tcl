...
topo readlammpsdata magnetite_3x3_1e5_mc_300_nvt.data

set log [open "z.data" w]
...
for {set x 0} {$x < $noctl} {incr x} {
        ...
        set oct_3 [atomselect top "type 4 and z>[lindex $zlayer $x 0] and z<[lindex $zlayer $x 1]"]
        set oct_2 [atomselect top "type 5 and z>[lindex $zlayer $x 0] and z<[lindex $zlayer $x 1]"]
